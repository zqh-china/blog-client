<template>
    <div>
        <n-button @click="showAddModel = true" color="#18a058">添加</n-button>
        <n-table :bordered="false" :single-line="false">
            ...
            <tbody>
                <tr v-for="(category, index) in categoryList">
                    ...
                    <td>
                        <n-space>
                            <n-button @click="toUpdate(category)" color="#1e9fff">修改</n-button>
                            <n-button @click="deleteCategory(category)" color="#ff5722">删除</n-button>
                        </n-space>
                    </td>
                </tr>
